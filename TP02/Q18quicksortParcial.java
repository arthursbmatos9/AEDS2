...
class Jogador {
    ...
    public static int ler(String resp) throws Exception{
    ...
    public static void main(String args[]) throws Exception {
        ...
        RandomAccessFile arquivoLog = new RandomAccessFile("matricula_quickParcial.txt","rw");
        ...
        ordenaQuicksort(array, 0, tamArray-1);
    ...
    public static void ordenaQuicksort(Jogador[] array, int esq, int dir) {
        ...
        while(i<=j){
            while(array[i].getEstadoNascimento().compareTo(array[pivo].getEstadoNascimento()) < 0 || (array[i].getEstadoNascimento().compareTo(array[pivo].getEstadoNascimento()) == 0 && array[i].getNome().compareTo(array[pivo].getNome()) < 0)){
                i++;
                nComp++;
            }
            while(array[j].getEstadoNascimento().compareTo(array[pivo].getEstadoNascimento()) > 0 || (array[j].getEstadoNascimento().compareTo(array[pivo].getEstadoNascimento()) == 0 && array[j].getNome().compareTo(array[pivo].getNome()) > 0)) {
                j--;
                nComp++;
            }
            if(i<=j){
        ...
        if(i< 10 && i< dir) ordenaQuicksort(array, i, dir);
