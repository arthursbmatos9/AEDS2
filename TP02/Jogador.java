...
class Jogador {
    ...
    public static void main(String args[]) throws Exception {
        ...
        RandomAccessFile arquivoLog = new RandomAccessFile("matricula_heapsort.txt", "rw");
        ...
        // ordenaQuicksort(array, 0, tamArray - 1); //ordenando primeiro por nome via
        // quicksort para depois ordenar por altura via heapsort

        double inicio = System.currentTimeMillis(); // pegando tempo inicial
        ordenaHeapSort(array, tamArray);
    ...
    public static void ordenaHeapSort(Jogador[] array, int n) {
        Jogador[] tmp = new Jogador[n + 1];
        System.arraycopy(array, 0, tmp, 1, n); // Copiando elementos para o array temporário
        ...
        // Copiando elementos de volta para o array original
        System.arraycopy(tmp, 1, array, 0, n);
    }
    ...
    public static void reconstruir(Jogador[] array, int tamHeap) {
        ...
        while (i <= tamHeap / 2) {
            ...
            // Se as alturas são iguais, compare os nomes
            if (array[i].getAltura() == array[filho].getAltura()) {
                // Se os nomes são diferentes, troque os jogadores se necessário
                if (array[i].getNome().compareTo(array[filho].getNome()) < 0) {
                    swap(array, i, filho);
                }
            }
            // Se as alturas são diferentes, compare as alturas normalmente
