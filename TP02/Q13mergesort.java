...
class Jogador {
    ...
    public static void main(String args[]) throws Exception {
        ...
        RandomAccessFile arquivoLog = new RandomAccessFile("matricula_mergesort.txt", "rw");
        ...
        ordenaMergeSort(array, 0, tamArray - 1);
    ...
    public static void ordenaMergeSort(Jogador[] array, int esq, int dir) {
        if (esq < dir) {
            int meio = (esq + dir) / 2;
            ordenaMergeSort(array, esq, meio);
            ordenaMergeSort(array, meio + 1, dir);
    ...
    public static void intercalar(Jogador[] array, int esq, int meio, int dir) {
        ...
        Jogador[] a1 = Arrays.copyOfRange(array, esq, esq + n1);
        Jogador[] a2 = Arrays.copyOfRange(array, meio + 1, meio + 1 + n2);
    
        int i = 0, j = 0, k = esq;
    
        while (i < n1 && j < n2) {
            nComp++;
            if ((a1[i].getUniversidade().compareTo(a2[j].getUniversidade()) < 0) || (a1[i].getUniversidade().compareTo(a2[j].getUniversidade()) == 0) && (a1[i].getNome().compareTo(a2[j].getNome()) < 0)) {
                nComp++;
                array[k++] = a1[i++];
            } else {
                nComp++;
        ...
        // Copia os elementos restantes de a1, se houver algum
        while (i < n1) {
            nMov++;
            array[k++] = a1[i++];
        }
    
        // Copia os elementos restantes de a2, se houver algum
        while (j < n2) {
            nMov++;
            array[k++] = a2[j++];
        }
