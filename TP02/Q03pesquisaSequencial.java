...
class Jogador {
    ...
    public static void main(String args[]) throws Exception {
        ...
        nomeProcurado = MyIO.readLine();
        while(!isFim(nomeProcurado)){
                boolean existe = pesquisaSequencial(array, nomeProcurado, tamArray);
                if(existe)
        ...
        arquivoLog.writeChars("801778\t"+nComp+"\t"+tempoExec);

        file.close();
        arquivoLog.close();
    }

    public static boolean pesquisaSequencial(Jogador[] array, String nomeProcurado, int tamArray){
        boolean existe = false;
        for(int i= 0; i< tamArray && !existe; i++){
